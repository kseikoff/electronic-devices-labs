...
\begin{document}
    ...
    Выполним расчеты параметров схемы. Определимся со стабилизатором
    $$
    ...
    $$
    9.1-8.6=0.5,\ 8.2-8.6=-0.4,\ |-0.4|<|0.5|\Rightarrow\text{ берем EDZV8.2B}
    $$
    Пересчитаем выходное напряжение
    $$
    U_{\text{вых.}}=U_{\text{ст.}}-0.6=8.2-0.6=7.6\text{ В}
    $$
    В теории теряем 5\% от желаемых 8 В. Далее рассчитаем сопротивление на резисторе.
    Для транзистора 2N3055 выберем $h_{\text{FE мин.}}$: $$\,20\leq h_{\text{FE}}\leq70\Rightarrow h_{\text{FE мин.}}=20$$
    Теперь посчитаем $R$
    $$
    U_{\text{вх. мин.}}>U_{\text{вых.}}+2.5=7.6+2.5=10.1\Rightarrow U_{\text{вх. мин.}}=11\text{ В},
    $$
    $$
    R\approx\dfrac{U_{\text{вх. мин.}}h_{\text{FE мин.}}}{1.2I_{\text{вых. макс.}}}=\dfrac{11\cdot20}{1.2\cdot I}
    $$
\end{document}